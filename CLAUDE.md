...
**📖 For comprehensive integration guide, see [AGENTS.md](AGENTS.md)** - This file contains detailed instructions for integrating this tool with various AI coding agents (Claude Code, Aider, Cursor, MCP servers, etc.).
